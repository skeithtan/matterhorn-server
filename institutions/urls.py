...
program_urls = [
    ...
    url(r'inbound/requirements/(?P<pk>(\d+))/$', InboundRequirementRetrieveUpdateDestroyView.as_view()),
    ...
    url(r'outbound/requirements/(?P<pk>(\d+))/$', OutboundRequirementRetrieveUpdateDestroyView.as_view()),
