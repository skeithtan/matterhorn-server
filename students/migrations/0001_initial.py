...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Student',
            fields=[
                ('category', models.CharField(choices=[('IN', 'Inbound'), ('OUT', 'Outbound')], max_length=4)),
                ('id_number', models.CharField(max_length=8, primary_key=True, serialize=False, unique=True)),
                ('college', models.CharField(choices=[('CCS', 'College of Computer Science'), ('RVRCOB', 'Ramon V del Rosario College of Business'), ('CLA', 'College of Liberal Arts'), ('SOE', 'School of Economics'), ('GCOE', 'Gokongwei College of Engineering'), ('COL', 'College of Law'), ('BAGCED', 'Brother Andrew Gonzales College of Education')], max_length=6)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program_offering', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='institutions.ProgramOffering')),
